...
gcc -shared ./src/Unity/cc/kogswrapper.c ./src/Unity/cc/loadcoins_jni.c -o ../libnspv-bin/libkogsplugin.so -L ./.libs -Wl,-soname,libkogsplugin.so -I ./include/ -I ./src/logdb/include/ -fPIC -Wl,-landroid
