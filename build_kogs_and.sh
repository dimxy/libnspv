...
gcc -shared ./src/Unity/cc/kogswrapper.c -o ../libnspv-bin/libkogsplugin.so ./.libs/libnspv.a -L ./src/secp256k1/.libs -Wl,-soname,libsecp256k1.so  -L ./src/tools/cryptoconditions/.libs -Wl,-soname,libcryptoconditions.so  -I ./include/ -I ./src/logdb/include/ -fPIC
