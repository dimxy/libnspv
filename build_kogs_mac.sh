...
gcc -shared ./src/Unity/cc/kogswrapper.c ./.libs/libnspv.a ./.libs/libbtc.a ./src/secp256k1/.libs/libsecp256k1.a ./src/tools/cryptoconditions/.libs/libcryptoconditions.a  -o ./.libs/libkogsplugin.dylib  -L ./.libs  -I ./include/  -I ./src/logdb/include/ -fPIC -levent -lgmp -lsodium
